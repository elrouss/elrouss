...
<br>
<i>* - можно кликнуть на каждый значок и в открытой вкладке увидеть в одном из проектов пример написанного мной кода (там же можно более подробно ознакомиться с каждой работой либо посмотреть репозитории <a href="https://github.com/elrouss#:~:text=Customize%20your%20pins-,Pinned,-react%2Dmesto%2Dauth">ниже</a>)</i>
